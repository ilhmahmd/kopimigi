  ...
  return (
    <main className="flex min-h-dvh items-center justify-center bg-gray-950 px-4 py-6 text-center sm:p-6">
      <section className="w-full max-w-sm">
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-brand-600 ring-4 ring-brand-500/30">
          <Camera size={38} />
        </div>
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <label className="block text-left text-sm font-medium text-gray-200">
            Kode Akses
            <input
              className="mt-2 block w-full rounded-xl border border-white/10 bg-white px-4 py-4 text-center text-3xl font-bold tracking-[0.3em] text-gray-950 outline-none focus:ring-2 focus:ring-brand-500"
              inputMode="numeric"
              maxLength={6}
              value={accessCode}
